...
// */
//class Camera2BasicFragment2 : Fragment(), FragmentCompat.OnRequestPermissionsResultCallback {
//
...
//          var file = File(Environment.getExternalStorageDirectory(),"TTImages_cache")
//          if(!file.exists()){
//            file.mkdirs()
//          }
//          f = File(file.getAbsolutePath() + "/" + "filename"+ "_" + count + ".png");
//          f1 = File(file.getAbsolutePath() + "/" + "filename_org"+ "_" + count + ".png");
//          f2 = File(file.getAbsolutePath() + "/" + "filename_merged"+ "_" + count + ".png");
//        }
//        count = count + 1
//        val ostream =  FileOutputStream(f);
//        drawView!!.getBitMap()?.compress(Bitmap.CompressFormat.JPEG, 100, ostream)
//        ostream.flush()
//        ostream.close()
//
//
//        val ostream2 =  FileOutputStream(f1);
//        bitMap?.compress(Bitmap.CompressFormat.JPEG, 100, ostream2)
//        ostream2.flush()
//        ostream2.close()
//
//
//        val ostream3 =  FileOutputStream(f2);
//        val result = Bitmap.createBitmap(bitMap!!.getWidth(), bitMap!!.getHeight(), bitMap!!.getConfig())
//        val canvas = Canvas(result);
//        canvas.drawBitmap(bitMap, 0f, 0f, Paint());
//        canvas.drawBitmap(drawView!!.getBitMap(), 0f, 0f, Paint());
//        result?.compress(Bitmap.CompressFormat.JPEG, 100, ostream3)
//        ostream3.flush()
//        ostream3.close()
//      }
//
...
//    mButton = view.findViewById(R.id.buttonLoadPictureNew);
...
//
//  /**
//   * Opens the camera specified by [Camera2BasicFragment2.cameraId].
//   */
...
//    this.bitMap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.width, bitmap.height)
//    var f2: File? = null
//    if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
//      var file = File(Environment.getExternalStorageDirectory(),"TTImages_cache")
//      if(!file.exists()){
//        file.mkdirs()
//      }
//      f2 = File(file.getAbsolutePath() + "/" + "filename_new"+ "_" + count + ".png");
//    }
//    count = count + 1
//    val ostream =  FileOutputStream(f2);
...
//    }
//
//    fun newInstance(): Camera2BasicFragment2 {
//      return Camera2BasicFragment2()
//    }
//  }
//}
